...
public static class IpAddressExtensions
{
    ...
    /// </summary>
    public static IRuleBuilderOptions<T, string?> MustBeIPv4<T>(this IRuleBuilder<T, string?> ruleBuilder)
    {
    ...
    /// </summary>
    public static IRuleBuilderOptions<T, string?> MustBeIPv6<T>(this IRuleBuilder<T, string?> ruleBuilder)
    {
        return ruleBuilder.Must(ip => 
            {
                if (string.IsNullOrWhiteSpace(ip)) 
